            ...
            <div className="mt-8">
              ...
              <div className="relative w-full" style={{ paddingBottom: "56.25%", background: "#000" }}>
                <iframe
                  ...
                  title="Zomato / Eternal — Deepinder Goyal on Building India's FoodTech Empire | UpForge"
            ...
            <div className="sticky top-4 flex flex-col gap-5">
              ...
              <div>
                ...
                <a href="https://youtu.be/l7pDuakyskI?si=zAxsfi7fsPWKKrrQ"
                  ...
                  className="block relative group" aria-label="Watch Zomato Eternal founder interview on YouTube">
                  <img
                    src="https://img.youtube.com/vi/l7pDuakyskI/maxresdefault.jpg"
                    alt="Deepinder Goyal — Zomato Eternal interview on India's food commerce empire"
                ...
                <p className="text-[9px] text-[#AAA] mt-1.5 italic" style={{ fontFamily: "system-ui,sans-serif" }}>
                  Deepinder Goyal on Eternal, Blinkit & India's food commerce future
                </p>
              </div>
