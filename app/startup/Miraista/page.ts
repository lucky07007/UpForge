...
import { ArrowRight, ArrowUpRight, ChevronRight, Brain, Calendar, MapPin, Users, TrendingUp, Building2, CheckCircle2, GraduationCap, Car, MessageSquare, FileText, Activity } from "lucide-react"

// ─── ENHANCED JSON-LD WITH CORRECTED NAME ────────────────────────────────────
const JSON_LD = {
  ...
  "@graph": [
    {
      ...
      "description": "Miraista founder story — Rachit and Bharat Parmar built a DeepTech product development and consulting company specializing in AI/ML, GenAI, and digital transformation. Creators of UKTI (AI EdTech) and an industry-leading Vehicle Damage Assessment AI solution.",
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "UKTI is an AI and Computer Vision-powered, activity-based learning platform designed for primary school children. It strengthens Foundational Literacy & Numeracy (FLN) and is aligned with India's National Education Policy (NEP) 2020."
          }
        },
        {
          "@type": "Question",
...
const TIMELINE = [
  ...
  { year: "2024", event: "Launches Vehicle Damage Assessment AI using RCNN and YOLO models, achieving 99.8% accuracy for insurance clients." },
...
const LESSON = "Miraista's journey shows that DeepTech consulting can be a launchpad for proprietary AI products. By first mastering enterprise-grade AI for clients in insurance and banking, they built the technical depth to then create UKTI—a socially impactful EdTech platform—without starting from scratch."
...
const PRODUCTS = [
  { name: "UKTI (EdTech)", desc: "AI + CV activity-based learning for FLN", icon: GraduationCap },
  { name: "Vehicle Damage Assessment AI", desc: "RCNN/YOLO-based claims automation", icon: Car },
  { name: "Multi-Language Chatbot AI", desc: "24/7 intelligent customer support", icon: MessageSquare },
  { name: "Document Processing Engine", desc: "OCR with 99.8% accuracy", icon: FileText },
]

const FAQS = [
  {
    q: "What specific AI models does Miraista use for vehicle damage assessment?",
    a: "Miraista's vehicle damage assessment solution uses a combination of RCNN for damage assessment and YOLO for object detection. This enables the system to process images in approximately 2.3 seconds with 99.8% accuracy."
  },
  {
    q: "How does UKTI align with India's National Education Policy (NEP) 2020?",
    a: "UKTI is specifically designed to support NEP 2020's focus on Foundational Literacy and Numeracy (FLN). It uses activity-based learning, real-time AI interaction, and contextual content to help primary school children build strong foundational skills."
  },
  {
    q: "What makes Miraista's chatbot different from other AI chatbots?",
    a: "Miraista's chatbot is a customized, multi-language AI agent designed for specific business contexts. It can be tailored for insurance claims, banking queries, or healthcare assistance, and supports multiple languages with 24/7 availability."
  },
  {
    q: "Is Miraista open to collaborations?",
    a: "Yes, based on their participation in events like Startup Mahakumbh and India AI Impact Summit, Miraista is actively seeking collaborations with schools, enterprises, and technology partners. You can contact them at coo@miraista.com."
  }
]
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#F3EFE5", fontFamily: "'Georgia', 'Times New Roman', serif" }}>
      ...
      <h1 className="sr-only">
        Miraista Founder Story — Rachit and Bharat Parmar | DeepTech AI and UKTI EdTech Platform | UpForge
      </h1>
      ...
      <nav aria-label="Breadcrumb" className="px-4 sm:px-8 py-2" style={{ background: "#EDE9DF", borderBottom: "1px solid #D8D2C4", fontFamily: "system-ui, sans-serif" }}>
        <ol className="flex flex-wrap items-center gap-1.5 text-[9px] text-[#AAA] uppercase tracking-widest">
          <li className="flex items-center gap-1.5"><Link href="/" className="hover:text-[#1A1208] transition-colors">UpForge</Link><ChevronRight className="w-2.5 h-2.5 text-[#C8C2B4]" /></li>
          <li className="flex items-center gap-1.5"><Link href="/startup" className="hover:text-[#1A1208] transition-colors">Startup Registry</Link><ChevronRight className="w-2.5 h-2.5 text-[#C8C2B4]" /></li>
          <li className="flex items-center gap-1.5"><span className="text-[#1A1208] font-semibold">Miraista</span></li>
        </ol>
      </nav>
      ...
      <header style={{ background: "#F3EFE5", borderBottom: "3px solid #1A1208" }}>
        <div className="text-center px-4 pt-3 pb-6" style={{ borderBottom: "1px solid #C8C2B4" }}>
          <p className="text-[8px] tracking-[0.44em] text-[#AAA] uppercase mb-2" style={{ fontFamily: "system-ui, sans-serif" }}>UpForge · Startup Registry · DeepTech and AI</p>
          <p className="pf font-black leading-none text-[#1A1208]" style={{ fontSize: "clamp(2rem, 5.5vw, 4.2rem)" }}>The Founder Chronicle</p>
          <p className="italic mt-2 text-[#6B5C40]" style={{ fontSize: "clamp(12px, 1.8vw, 15px)" }}>India's independent startup registry — verified, editorial, April 2026</p>
        ...
        <div className="flex items-center px-4 sm:px-8 py-2 gap-4" style={{ fontFamily: "system-ui, sans-serif", borderBottom: "1px solid #C8C2B4" }}>
          ...
          <span className="text-[9px] font-black uppercase tracking-wider" style={{ color: accent }}>AI Consulting · Product Innovation · April 2026</span>
          <div className="h-3 w-px bg-[#C8C2B4]" />
      ...
      <main className="fade-up max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid lg:grid-cols-[1fr_380px] xl:grid-cols-[1fr_420px]" style={{ borderBottom: "2px solid #1A1208" }}>
          ...
          <article className="py-8 lg:pr-8" style={{ borderRight: "1px solid #C8C2B4" }}>
            <div className="flex items-center gap-3 mb-5" style={{ fontFamily: "system-ui, sans-serif" }}>
              <span className="text-[8.5px] font-black tracking-[0.28em] uppercase px-3 py-1.5 text-white" style={{ background: accent }}>DEEPTECH / AI PRODUCTS</span>
            ...
            <h2 className="pf font-black leading-[1.05] text-[#1A1208] mb-5" style={{ fontSize: "clamp(1.8rem, 4vw, 3.2rem)" }}>
              From building AI for enterprises to launching <span className="gradient-text">India's most thoughtful EdTech platform.</span>
            </h2>

            <p className="italic leading-[1.75] mb-6 pb-6 text-[#5A4A30]" style={{ fontSize: "clamp(14px, 1.9vw, 17px)", borderBottom: "1px solid #C8C2B4" }}>
              Miraista started as a DeepTech consulting firm, helping insurers automate vehicle damage assessment with 99.8% accurate AI. Then they asked a bigger question: if AI can understand car damage, can it help a child learn to read? The result is UKTI — an activity-based learning platform launched at IIT Madras with India's Education Minister. From RCNN and YOLO to foundational literacy, this is the story of Rachit and Bharat Parmar's journey to engineer intelligence with purpose.
            </p>

            <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mb-8" style={{ fontFamily: "system-ui, sans-serif" }}>
              {["By UpForge Editorial", "Delhi", "Est. 2020", "DeepTech AI Studio"].map((t, i, a) => (
            ...
            <div className="lg:hidden mb-8">
              <div className="w-full flex items-center justify-center" style={{ height: "min(300px, 60vw)", background: "#E0E7FF" }}>
              ...
              <div className="px-4 py-3" style={{ background: "#1A1208" }}>
                ...
                <p className="text-white/40 text-[9px] uppercase tracking-wide mt-0.5" style={{ fontFamily: "system-ui, sans-serif" }}>Co-Founders · Miraista</p>
              </div>
            </div>
            ...
            <div className="mt-10 pt-6 pb-6 text-center" style={{ borderTop: `3px double ${accent}`, borderBottom: "1px solid #C8C2B4" }}>
              <span style={{ display: "block", color: accentDark, fontSize: 24, marginBottom: 10 }}>❝</span>
              <blockquote className="pf italic text-[#1A1208] leading-[1.7] max-w-2xl mx-auto px-4" style={{ fontSize: "clamp(16px, 2.2vw, 22px)" }}>"{PULL_QUOTE.text}"</blockquote>
              <p className="text-[9px] uppercase tracking-[0.24em] text-[#AAA] mt-4" style={{ fontFamily: "system-ui, sans-serif" }}>— {PULL_QUOTE.by}</p>
            </div>
                ...
                {TIMELINE.map((t, i) => (
                  <li key={i} className="flex gap-4 mb-4 group">
                    <div className="flex flex-col items-center flex-shrink-0">
                      <div className="w-2.5 h-2.5 rounded-full mt-1.5 flex-shrink-0 transition-all duration-200 group-hover:scale-125" style={{ background: accent }} />
          ...
          <aside className="hidden lg:block pl-8 pt-8 pb-8">
            <div className="sticky top-4 flex flex-col gap-5">
              <div className="relative w-full overflow-hidden rounded-sm shadow-md" style={{ height: 340, background: "#E0E7FF" }}>
                <div className="w-full h-full flex items-center justify-center"><Brain className="w-20 h-20 text-[#3B82F6] opacity-30" /></div>
              ...
              <div className="flex flex-col gap-2">
                <a href="https://miraista.com" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between px-4 py-2.5 transition-all hover:opacity-80 rounded-sm" style={{ border: `1.5px solid ${accent}`, textDecoration: "none" }}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: accent, fontFamily: "system-ui, sans-serif" }}>miraista.com — Official Website</span>
                  </div>
                  <ArrowUpRight className="w-3.5 h-3.5" style={{ color: accent }} />
                </a>
                <a href="https://www.linkedin.com/company/miraista" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between px-4 py-2.5 transition-all hover:opacity-80 rounded-sm" style={{ border: "1.5px solid #0077b5", textDecoration: "none" }}>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider" style={{ color: "#0077b5", fontFamily: "system-ui, sans-serif" }}>LinkedIn — Miraista</span>
                  </div>
              ...
              <div style={{ border: "2px solid #1A1208" }} className="rounded-sm overflow-hidden">
                <div className="px-4 py-2.5" style={{ background: "#1A1208" }}><p className="text-[8px] font-black uppercase tracking-[0.3em] text-white" style={{ fontFamily: "system-ui, sans-serif" }}>Miraista at a Glance</p></div>
                  ...
                  {STATS.map((s, i) => {
                    ...
                    return (
                      <div key={i} className="px-4 py-3" style={{ borderColor: "#D8D2C4" }}>
                        <dt className="text-[7.5px] text-[#AAA] uppercase tracking-[0.16em] mb-1 flex items-center gap-1" style={{ fontFamily: "system-ui, sans-serif" }}><IconComponent className="w-2.5 h-2.5" style={{ color: accent }} />{s.l}</dt>
              ...
              <div style={{ border: "1px solid #D8D2C4" }} className="rounded-sm overflow-hidden">
                <div className="px-4 py-2" style={{ background: "#F9F7F2", borderBottom: "1px solid #D8D2C4" }}><p className="text-[8px] font-black uppercase tracking-[0.24em] text-[#1A1208]" style={{ fontFamily: "system-ui, sans-serif" }}>Flagship Products</p></div>
                  ...
                  {PRODUCTS.map((product, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-start gap-2">
                        ...
                        <div><p className="text-[10px] font-bold text-[#1A1208]">{product.name}</p><p className="text-[8px] text-[#6B5C40]">{product.desc}</p></div>
                      </div>
                    )
                  })}
                </div>
              ...
              <div className="px-4 py-4 rounded-sm" style={{ background: accentBg, border: `1px solid ${accentBorder}` }}>
              ...
              <div style={{ border: "1px solid #D8D2C4" }} className="rounded-sm overflow-hidden">
                <div className="px-4 py-2" style={{ background: "#F9F7F2", borderBottom: "1px solid #D8D2C4" }}><p className="text-[8px] font-black uppercase tracking-[0.24em] text-[#1A1208]" style={{ fontFamily: "system-ui, sans-serif" }}>Incubation & Recognition</p></div>
                <div className="px-4 py-3 space-y-1.5">
                  {INVESTORS.map((inv, i) => (
                    <div key={i} className="flex items-center justify-between text-[11px] text-[#2C2010]" style={{ fontFamily: "system-ui, sans-serif" }}>
                      <div className="flex items-center gap-2"><span style={{ width: 6, height: 6, borderRadius: 1, background: accent, display: "inline-block", flexShrink: 0 }} /><span className="font-medium">{inv.name}</span></div>
              ...
              <div><p className="text-[8px] font-black uppercase tracking-[0.26em] mb-3" style={{ color: "#AAA", fontFamily: "system-ui, sans-serif" }}>Also Read on UpForge</p>
                {RELATED.map((r) => (
                  <Link key={r.slug} href={`/startup/${r.slug}`} className="flex items-center justify-between py-2.5 hover:opacity-70 transition-opacity" style={{ borderBottom: "1px solid #EDE9DF", textDecoration: "none" }}>
        ...
        <section className="py-8" style={{ borderBottom: "1px solid #C8C2B4" }}>
          <p className="text-[9px] tracking-[0.3em] uppercase text-[#AAA] mb-4" style={{ fontFamily: "system-ui, sans-serif" }}>Explore More DeepTech & AI Startups on UpForge</p>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <Link key={lnk.h} href={lnk.h} className="flex items-center justify-between gap-1 p-3 hover:border-[#1A1208] transition-all rounded-sm hover-lift" style={{ border: "1px solid #D8D2C4", background: "white", textDecoration: "none" }}>
                <div><span className="text-[10px] font-bold uppercase tracking-wider text-[#1A1208] block" style={{ fontFamily: "system-ui, sans-serif" }}>{lnk.l}</span><span className="text-[7px] text-[#AAA] uppercase tracking-wider hidden sm:inline-block">{lnk.desc}</span></div>
        ...
        <footer className="pt-8 pb-2">
          <div className="grid sm:grid-cols-2 gap-6 items-center pb-8" style={{ borderBottom: "1px solid #D8D2C4" }}>
            <div><p className="pf font-bold text-[#1A1208] mb-2" style={{ fontSize: "1.2rem" }}>Building India's next DeepTech unicorn? Get verified on UpForge.</p><p className="text-[12px] text-[#6B5C40]" style={{ fontFamily: "system-ui, sans-serif" }}>Free startup profiles. Independent verification. Indexed by Google.</p></div>
            <div className="flex sm:justify-end"><Link href="/submit" className="inline-flex items-center gap-2 px-6 py-3.5 text-white font-bold uppercase tracking-wider hover:opacity-90 transition-all rounded-sm" style={{ background: "#1A1208", fontSize: 11, fontFamily: "system-ui, sans-serif", textDecoration: "none" }}>List Your Startup — Free <ArrowRight className="w-3.5 h-3.5" /></Link></div>
          </div>
          <p className="text-[9px] leading-relaxed mt-4" style={{ color: "#BBB0A0", fontFamily: "system-ui, sans-serif" }}>* Data sourced from Miraista's official website, LinkedIn page, press releases, and event participations (Bharat Bodhan AI Conclave 2026, Startup ka Mahakumbh, India AI Impact Summit 2026) as of April 2026. UpForge is an independent registry — no paid placements, no sponsored rankings.</p>
