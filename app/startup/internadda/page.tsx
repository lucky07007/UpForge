...
const JSON_LD = {
  ...
  "@graph": [
    {
      "@type": "Article",
      "@id": "https://upforge.in/startup/internadda#article",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Edtech / Career", "item": "https://upforge.in/edtech-startups" },
        { "@type": "ListItem", "position": 4, "name": "InternAdda", "item": "https://upforge.in/startup/internadda" }
      ]
    },
    {
      "@type": "FAQPage",
      "mainEntity": [
        { "@type": "Question", "name": "What is InternAdda?", "acceptedAnswer": { "@type": "Answer", "text": "InternAdda is an Indian career platform founded by Lucky Tiwari in 2024 to connect college students with internships, startup roles, and early-career opportunities. The platform focuses on making career opportunities accessible to students from all colleges, including Tier-2 and Tier-3 institutions." } },
        { "@type": "Question", "name": "Who founded InternAdda?", "acceptedAnswer": { "@type": "Answer", "text": "InternAdda was founded by Lucky Tiwari. He built the platform after observing that millions of Indian students struggle to find meaningful internships and career opportunities, especially those without premium college brands or established professional networks." } },
        { "@type": "Question", "name": "How does InternAdda help students?", "acceptedAnswer": { "@type": "Answer", "text": "InternAdda provides a curated, accessible platform where students can discover verified internships and startup job opportunities. The platform is designed to be mobile-friendly and accessible to students from smaller cities, giving them access to the startup ecosystem that was previously only available through informal networks." } },
        { "@type": "Question", "name": "Is InternAdda free for students?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, InternAdda is free for students. The platform's mission is to democratise access to career opportunities for all Indian students, regardless of their college or city." } },
      ]
    }
  ]
}
...
export default function InternAddaPage() {
  useEffect(() => {
    const s = document.getElementById("internadda-jsonld")
    if (!s) {
      const el = document.createElement("script")
      el.id = "internadda-jsonld"; el.type = "application/ld+json"
      el.textContent = JSON.stringify(JSON_LD); document.head.appendChild(el)
    }
    return () => { document.getElementById("internadda-jsonld")?.remove() }
  }, [])

  useEffect(() => {
    document.title = "Lucky Tiwari — InternAdda Founder | India's Student Career Platform | UpForge"
  }, [])
    ...
    <div style={{ minHeight: "100vh", background: "#F3EFE5", fontFamily: "'Georgia','Times New Roman',serif" }} role="main">
      ...
      <nav aria-label="Breadcrumb" className="px-4 sm:px-8 py-2" style={{ background: "#EDE9DF", borderBottom: "1px solid #D8D2C4", fontFamily: "system-ui,sans-serif" }}>
        <ol className="flex flex-wrap items-center gap-1.5 text-[9px] text-[#AAA] uppercase tracking-widest" itemScope itemType="https://schema.org/BreadcrumbList">
          {[{ n: "UpForge", h: "/" }, { n: "Startup Registry", h: "/startup" }, { n: "Edtech / Career", h: "/edtech-startups" }, { n: "InternAdda", h: "/startup/internadda" }].map((b, i, arr) => (
      ...
      <header style={{ background: "#F3EFE5", borderBottom: "3px solid #1A1208" }}>
        <div className="text-center px-4 pt-3 pb-6" style={{ borderBottom: "1px solid #C8C2B4" }}>
          <p className="text-[8px] tracking-[0.44em] text-[#AAA] uppercase mb-2" style={{ fontFamily: "system-ui,sans-serif" }}>UpForge · Startup Registry · Career / Edtech</p>
      ...
      <main className="fade-up max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="grid lg:grid-cols-[1fr_380px] xl:grid-cols-[1fr_420px]" style={{ borderBottom: "2px solid #1A1208" }} itemScope itemType="https://schema.org/Article">
          ...
          <link itemProp="url" href="https://upforge.in/startup/internadda" />
          ...
          <article className="py-8 lg:pr-8" style={{ borderRight: "1px solid #C8C2B4" }}>
            ...
            <div className="lg:hidden mb-8">
              <img src="/luckyinternadda.jpg" alt="Lucky Tiwari, Founder at InternAdda" className="w-full object-cover object-top" style={{ height: "min(280px,55vw)" }} loading="eager" />
            ...
            <div className="mt-10 pt-6 pb-6 text-center" style={{ borderTop: `3px solid ${accent}`, borderBottom: "1px solid #C8C2B4" }}>
              ...
              <p className="text-[9px] uppercase tracking-[0.24em] text-[#AAA] mt-4" style={{ fontFamily: "system-ui,sans-serif" }}>— Lucky Tiwari, Founder, InternAdda</p>
            </div>

            <div className="mt-8">
              <p className="text-[8.5px] font-black uppercase tracking-[0.26em] mb-3" style={{ color: accent, fontFamily: "system-ui,sans-serif", borderBottom: `1px solid ${accentBorder}`, paddingBottom: 8 }}>Watch · InternAdda in Conversation</p>
              <div className="relative w-full" style={{ paddingBottom: "56.25%", background: "#000" }}>
                <iframe src="https://www.youtube.com/embed/l7pDuakyskI?si=zAxsfi7fsPWKKrrQ" title="InternAdda — Lucky Tiwari Founder Interview | UpForge" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen className="absolute inset-0 w-full h-full" loading="lazy" style={{ border: "none" }} />
              </div>
              <p className="text-[10px] text-[#AAA] mt-2 italic" style={{ fontFamily: "system-ui,sans-serif" }}>Lucky Tiwari on building InternAdda — UpForge Featured Interview</p>
            </div>
            ...
            <div className="mt-8 p-5" style={{ background: accentBg, border: `1.5px solid ${accentBorder}` }}>
              ...
              <p className="pf italic text-[#1A1208] leading-[1.7]" style={{ fontSize: "clamp(14px,1.8vw,17px)" }}>Sometimes the best startups are built by solving a problem you personally faced — because you understand the pain better than any investor ever will.</p>
            </div>
            ...
            <section className="mt-8" itemScope itemType="https://schema.org/FAQPage">
              ...
              {[
              { q: "What is InternAdda?", a: "InternAdda is an Indian career platform founded by Lucky Tiwari in 2024 to connect college students with internships, startup roles, and early-career opportunities. The platform focuses on making career opportunities accessible to students from all colleges, including Tier-2 and Tier-3 institutions." },
              { q: "Who founded InternAdda?", a: "InternAdda was founded by Lucky Tiwari. He built the platform after observing that millions of Indian students struggle to find meaningful internships and career opportunities, especially those without premium college brands or established professional networks." },
              { q: "How does InternAdda help students?", a: "InternAdda provides a curated, accessible platform where students can discover verified internships and startup job opportunities. The platform is designed to be mobile-friendly and accessible to students from smaller cities, giving them access to the startup ecosystem that was previously only available through informal networks." },
              { q: "Is InternAdda free for students?", a: "Yes, InternAdda is free for students. The platform's mission is to democratise access to career opportunities for all Indian students, regardless of their college or city." },
              ].map((faq, i) => (
          ...
          <aside className="hidden lg:block pl-8 pt-8 pb-8">
            <div className="sticky top-4 flex flex-col gap-5">
              <div className="relative w-full overflow-hidden" style={{ height: 340 }}>
                <img src="/luckyinternadda.jpg" alt="Lucky Tiwari, InternAdda — UpForge Founder Chronicle" className="w-full h-full object-cover object-top" loading="eager" itemProp="image" />
              ...
              <div>
                ...
                <a href="https://youtu.be/l7pDuakyskI?si=zAxsfi7fsPWKKrrQ" target="_blank" rel="noopener noreferrer" className="block relative group" aria-label="Watch InternAdda founder interview on YouTube">
                  <img src="https://img.youtube.com/vi/l7pDuakyskI/maxresdefault.jpg" alt="Lucky Tiwari — InternAdda founder interview" className="w-full object-cover" style={{ height: 140, border: `1px solid ${accentBorder}` }} loading="lazy" onError={(e) => { (e.target as HTMLImageElement).src = "https://img.youtube.com/vi/l7pDuakyskI/hqdefault.jpg" }} />
              ...
              <div className="px-4 py-4" style={{ background: accentBg, border: `1px solid ${accentBorder}` }}>
                ...
                <p className="italic text-[#1A1208] leading-[1.72]" style={{ fontSize: 13 }}>Sometimes the best startups are built by solving a problem you personally faced — because you understand the pain better than any investor ever will.</p>
              </div>
