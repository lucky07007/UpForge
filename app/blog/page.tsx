...
// v2: Added global trending startups section alongside India content.
// Hero, secondary, grid, and opinion sections updated for global reach.
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .blog-eyebrow { font-size: 9px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.32em; color: rgba(94,234,212,0.85); margin-bottom: 16px; font-family: system-ui, sans-serif; display: block; }
        ...
        <div className="blog-hero">
          ...
          <div className="blog-mast">
            <div className="blog-mast-content ri-0">
              <span className="blog-eyebrow">UpForge · Independent Startup Intelligence · India &amp; Global</span>
