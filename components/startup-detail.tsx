          ...
          <main className="py-8 md:py-12">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8 mb-8 pb-8 border-b-2 border-foreground">
              ...
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 text-xs text-muted-foreground font-mono mb-4">
                  <span className="inline-block w-2 h-2 rounded-full bg-[#C59A2E]" />
                  <span>{isPending ? "Review Pending" : "Reviewed July 2026 • Registry Record Verified"}</span>
                </div>
                    ...
                    <div className="text-center w-full mb-6 pb-6 border-b border-border">
                      ...
                      <div className="flex flex-col items-center justify-center gap-1.5">
                        <span className="font-serif font-bold text-xl text-foreground">
                          {isPending ? 'Pending Verification' : 'Verified Listing'}
                        </span>
                        <span className="text-[11px] text-muted-foreground font-mono">
                          {isPending ? 'Under Review' : 'Reviewed July 2026'}
                        </span>
                      </div>
                    </div>
