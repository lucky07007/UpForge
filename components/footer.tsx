        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-sm text-zinc-400 leading-relaxed max-w-sm">
              India’s independent startup verification registry. 
              Building transparency, credibility, and institutional-grade trust for founders.
            </p>
            ...
            <div className="flex items-center gap-6 pt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-zinc-300">Trusted Network</span>
              </div>
            </div>
          </div>
              ...
              <div className="bg-[#0a1726] rounded-[2.4rem] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8 border border-white/5">
                <div className="space-y-3 text-center md:text-left">
                  ...
                  <p className="text-zinc-400 text-sm max-w-md">
                    Reach investors, founders, and decision-makers actively exploring verified startups.
                  </p>
                </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-4 pt-4">
              <a
                ...
                aria-label="LinkedIn"
              >
                <span className="text-xs font-bold text-white hover:text-[#0f1e2f]">
                  in
                </span>
              </a>
